...
var USPolicyRate = schema.RangeSet{
	{Min: nil, Max: schema.PtrValReverse(1.0), Status: metric_status.Excellent},
	{Min: schema.PtrValReverse(1.0), Max: schema.PtrValReverse(3.0), Status: metric_status.Good},
	{Min: schema.PtrValReverse(3.0), Max: schema.PtrValReverse(5.0), Status: metric_status.Moderate},
	{Min: schema.PtrValReverse(5.0), Max: schema.PtrValReverse(7.0), Status: metric_status.Warning},
	{Min: schema.PtrValReverse(7.0), Max: schema.PtrValReverse(10.0), Status: metric_status.Danger},
	{Min: schema.PtrValReverse(10.0), Max: nil, Status: metric_status.Critical},
}

var USInflation = schema.RangeSet{
	...
	{Min: schema.PtrValReverse(3.0), Max: schema.PtrValReverse(4.5), Status: metric_status.Moderate},
	{Min: schema.PtrValReverse(4.5), Max: schema.PtrValReverse(6.0), Status: metric_status.Warning},
	{Min: schema.PtrValReverse(6.0), Max: schema.PtrValReverse(8.0), Status: metric_status.Danger},
	{Min: schema.PtrValReverse(8.0), Max: nil, Status: metric_status.Critical},
}

var USUnemployment = schema.RangeSet{
...
var USEquityYoY = schema.RangeSet{
...
var USDollarIndex = schema.RangeSet{
	{Min: schema.PtrValReverse(105), Max: nil, Status: metric_status.Excellent},
	{Min: schema.PtrValReverse(100), Max: schema.PtrValReverse(105), Status: metric_status.Good},
	{Min: schema.PtrValReverse(95), Max: schema.PtrValReverse(100), Status: metric_status.Moderate},
	{Min: schema.PtrValReverse(92), Max: schema.PtrValReverse(95), Status: metric_status.Warning},
	{Min: schema.PtrValReverse(90), Max: schema.PtrValReverse(92), Status: metric_status.Danger},
	{Min: nil, Max: schema.PtrValReverse(90), Status: metric_status.Critical},
}

var USBond10Y = schema.RangeSet{
	{Min: schema.PtrValReverse(1.0), Max: schema.PtrValReverse(3.0), Status: metric_status.Excellent},
	{Min: schema.PtrValReverse(3.0), Max: schema.PtrValReverse(4.0), Status: metric_status.Good},
	{Min: schema.PtrValReverse(4.0), Max: schema.PtrValReverse(5.0), Status: metric_status.Moderate},
	{Min: schema.PtrValReverse(5.0), Max: schema.PtrValReverse(6.0), Status: metric_status.Warning},
	{Min: schema.PtrValReverse(6.0), Max: schema.PtrValReverse(8.0), Status: metric_status.Danger},
	{Min: schema.PtrValReverse(8.0), Max: nil, Status: metric_status.Critical},
}
